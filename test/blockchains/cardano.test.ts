...
describe('Cardano blockchain', () => {
  ...
  describe('validateAddress', () => {
    it('validates cardano mainnet addresses generated by the library', () => {
      ...
      expect(blockchain.validateAddress(addressBase)).toBe(true)
      expect(blockchain.validateAddress(addressEnterprise)).toBe(true)
      expect(blockchain.validateAddress(addressStake)).toBe(true)
    })
    ...
    it('validates cardano testnet addresses generated by the library', () => {
      ...
      expect(blockchain.validateAddress(addressTestnet)).toBe(true)
    })
